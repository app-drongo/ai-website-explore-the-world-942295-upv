...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Discover breathtaking destinations and create unforgettable memories with our expertly curated travel experiences. Join thousands of adventurers who trust us to make their dream journeys come true.',
  contactEmail: 'adventures@exploretheworld.com',
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Group Travel', href: '/groups', editableId: 'link-footer-groups' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Traveler Community', href: '/community', editableId: 'link-footer-community' },
        { name: 'Packing Lists', href: '/packing', editableId: 'link-footer-packing' },
        { name: 'Travel Tips', href: '/tips', editableId: 'link-footer-tips' },
        { name: 'Photo Gallery', href: '/gallery', editableId: 'link-footer-gallery' },
        { name: 'Trip Status', href: '/status', editableId: 'link-footer-status' },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Booking Terms', href: '/booking-terms', editableId: 'link-footer-booking' },
  ...
  const bottomLinks = [
    ...
    { name: 'Travel Support', href: '/support', editableId: 'link-footer-support' },
  ];
